...
const Word Word::primary("primary", Tag::PRIMARY);
const Word Word::key("key", Tag::KEY);
const Word Word::use("use", Tag::USE);
const Word Word::where("where", Tag::WHERE);
const Word Word::sqm("\'", Tag::SQM);