...
public:
	 ...
	 static const Word select, Delete, insert, update, Not, null, into, value, values,
		 from, create, drop, table, database, set, equal, mt, lt, le, ge, nq, lpa, rpa,
		 smc, cma, dot, udl, Int, Float, Char, varchar, primary, key, use, where,sqm;
